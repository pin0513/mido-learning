...
| **(scoreboard)** | Authenticated | Family Scoreboard (主頁面 + Admin + Super Admin) |
| **(player)** | Player JWT | Family Scoreboard 玩家獨立登入端 |
...
| **FamilyScoreboardEndpoints.cs** | `/api/family-scoreboard/*` | Family Scoreboard API (60+ endpoints) |
| **DevEndpoints.cs** | `/api/dev/*` | Dev-only helpers (Player JWT, E2E support) |
...
| `e2e/family-scoreboard.spec.ts` | `frontend/e2e/` | Family Scoreboard API E2E tests (56 tests) |
