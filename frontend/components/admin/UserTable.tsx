        ...
        {users.map((user) => (
          ...
          >
            ...
            <div className="mb-3">
              ...
              {user.displayName && (
                <div className="text-sm text-gray-500 mt-1">{user.displayName}</div>
              )}
            </div>
            ...
            <div className="mb-3 grid grid-cols-2 gap-3 text-sm">
              <div>
                <label className="block text-xs font-medium text-gray-500 mb-1">建立時間</label>
                <span className="text-gray-700">{formatDate(user.createdAt)}</span>
              </div>
              <div>
                <label className="block text-xs font-medium text-gray-500 mb-1">最後登入</label>
            ...
            {isProtectedUser(user.email) && (
              <div className="mt-3 pt-3 border-t border-gray-200 text-center">
                <span className="text-xs text-gray-400">此用戶受保護，無法刪除</span>
              </div>
            )}
          </div>
        ))}
